...
License  : NCSA
Requires: compat-icu4c-soname61-bin = %{version}-%{release}
Requires: compat-icu4c-soname61-data = %{version}-%{release}
Requires: compat-icu4c-soname61-lib = %{version}-%{release}
Requires: compat-icu4c-soname61-license = %{version}-%{release}
Requires: compat-icu4c-soname61-man = %{version}-%{release}
...
%package bin
Summary: bin components for the compat-icu4c-soname61 package.
Group: Binaries
Requires: compat-icu4c-soname61-data = %{version}-%{release}
Requires: compat-icu4c-soname61-license = %{version}-%{release}
Requires: compat-icu4c-soname61-man = %{version}-%{release}
...
%description bin
bin components for the compat-icu4c-soname61 package.


%package data
Summary: data components for the compat-icu4c-soname61 package.
Group: Data

%description data
data components for the compat-icu4c-soname61 package.


%package dev
Summary: dev components for the compat-icu4c-soname61 package.
Group: Development
Requires: compat-icu4c-soname61-lib = %{version}-%{release}
Requires: compat-icu4c-soname61-bin = %{version}-%{release}
Requires: compat-icu4c-soname61-data = %{version}-%{release}
Provides: compat-icu4c-soname61-devel = %{version}-%{release}

%description dev
dev components for the compat-icu4c-soname61 package.


%package dev32
Summary: dev32 components for the compat-icu4c-soname61 package.
Group: Default
Requires: compat-icu4c-soname61-lib32 = %{version}-%{release}
Requires: compat-icu4c-soname61-bin = %{version}-%{release}
Requires: compat-icu4c-soname61-data = %{version}-%{release}
Requires: compat-icu4c-soname61-dev = %{version}-%{release}

%description dev32
dev32 components for the compat-icu4c-soname61 package.
...
%package man
Summary: man components for the compat-icu4c-soname61 package.
Group: Default

%description man
man components for the compat-icu4c-soname61 package.
...
export LANG=C
export SOURCE_DATE_EPOCH=1541638990
pushd source
...
%files
%defattr(-,root,root,-)
%exclude /usr/lib32/icu/61.1/Makefile.inc
%exclude /usr/lib32/icu/61.1/pkgdata.inc
%exclude /usr/lib32/icu/Makefile.inc
%exclude /usr/lib32/icu/current
%exclude /usr/lib32/icu/pkgdata.inc
%exclude /usr/lib64/icu/61.1/Makefile.inc
%exclude /usr/lib64/icu/61.1/pkgdata.inc
...
%files data
%defattr(-,root,root,-)
%exclude /usr/share/icu/61.1/LICENSE
%exclude /usr/share/icu/61.1/config/mh-linux
%exclude /usr/share/icu/61.1/install-sh
%exclude /usr/share/icu/61.1/mkinstalldirs
...
%exclude /usr/share/package-licenses/compat-icu4c-soname61/license.html
