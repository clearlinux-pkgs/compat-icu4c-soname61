...
rm -f %{buildroot}/usr/lib32/icu/61.1/Makefile.inc
rm -f %{buildroot}/usr/lib32/icu/61.1/pkgdata.inc
rm -f %{buildroot}/usr/lib32/icu/Makefile.inc
rm -f %{buildroot}/usr/lib32/icu/pkgdata.inc
rm -f %{buildroot}/usr/lib64/icu/61.1/Makefile.inc
rm -f %{buildroot}/usr/lib64/icu/61.1/pkgdata.inc
...
rm -f %{buildroot}/usr/share/icu/61.1/LICENSE
rm -f %{buildroot}/usr/share/icu/61.1/config/mh-linux
rm -f %{buildroot}/usr/share/icu/61.1/install-sh
rm -f %{buildroot}/usr/share/icu/61.1/mkinstalldirs
...
rm -f %{buildroot}/usr/share/package-licenses/compat-icu4c-soname61/license.html
